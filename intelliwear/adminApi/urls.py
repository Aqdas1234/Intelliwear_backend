...
from .views import AdminReturnRequestListView, AdminReturnRequestView, ProfileView,AdminCustomerListView,AdminCustomerDetailView,ProductViewSet,CarouselViewSet , AdminOrderListView , AdminUpdateOrderStatusView,AdminAnalyticsView , AdminReviewListView
...
urlpatterns = [
    ...
    path("reviews/<uuid:review_id>/", AdminReviewListView.as_view(), name="delete-review"),
]